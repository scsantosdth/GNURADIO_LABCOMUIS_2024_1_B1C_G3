...
class Lab1B_Punto4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab1_ParteB")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab1B_Punto4")
...
def main(top_block_cls=Lab1B_Punto4, options=None):
